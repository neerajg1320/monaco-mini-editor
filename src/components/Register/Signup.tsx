...
const Signup: React.FC = () => {
  ...
  return (
    ...
    >
      <form className='flex flex-col bg-red-500  items-center pt-14 text-lg gap-6 pb-5 form-background sm:w-1/2 rounded-lg form-box-shadow w-3/4'>
        ...
        <div className={verifyEmailMsg?`block`:'invisible'}>Verfication Email has been sent</div>
      </form>
    </div>
  )
}
